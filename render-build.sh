...
export APP_VERSION="${APP_VERSION:-Vitória Régia One v14.0.3}"
export VITE_APP_VERSION="${VITE_APP_VERSION:-Vitória Régia One v14.0.3}"
...
printf '\n==> Validando chamadas, RSVP, exclusões, layout, OCR e UTF-8...\n'
