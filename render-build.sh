...
export APP_VERSION="${APP_VERSION:-Vitória Régia One v14.0.2}"
export VITE_APP_VERSION="${VITE_APP_VERSION:-Vitória Régia One v14.0.2}"
...
printf '\n==> Validando chamadas contextuais, RSVP, lembretes, OCR e UTF-8...\n'
