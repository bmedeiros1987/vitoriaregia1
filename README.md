...
## Opção de baixar App Android

Foi adicionada a aba **App Android** no sistema e um botão na tela inicial para baixar o APK da portaria.

O botão aponta para a release estável do GitHub:

```text
https://github.com/bmedeiros1987/vitoriaregia1/releases/download/android-portaria-latest/vitoria-regia-portaria.apk
```

Para gerar/publicar o APK:

1. Suba o conteúdo extraído deste ZIP no GitHub.
2. Acesse **Actions**.
3. Execute o workflow **Build Android APK**.
4. O workflow irá compilar o projeto `android-portaria/`, gerar o APK e publicar na release `android-portaria-latest`.

O APK é apenas para Android e abre o sistema em `https://vitoriaregia1.onrender.com/#portaria`, exigindo login de portaria.

## WhatsApp via Periskope API

Esta versão também suporta Periskope API como provedor de WhatsApp automático. Veja `README_PERISKOPE_API.md`.
