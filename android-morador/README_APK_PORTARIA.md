# APK Vitória Régia Morador

Este pacote cria um APK Android em formato WebView para acessar o sistema Vitória Régia, abrindo diretamente a área do morador:

https://vitoriaregia1.onrender.com/#dashboard

## Funcionalidades pensadas para porteiros

- Acesso rápido ao sistema pelo ícone do aplicativo.
- Abre diretamente na área do morador.
...
7. Aguarde finalizar.
8. Baixe o artifact chamado `vitoria-regia-morador-debug-apk`.
...
4. Instale o app.
5. Abra o app **Vitória Régia Morador**.
...
```xml
<string name="site_url">https://vitoriaregia1.onrender.com/#dashboard</string>
```

Também altere em:

`app/src/main/java/br/com/vitoriaregia/morador/MainActivity.java`
