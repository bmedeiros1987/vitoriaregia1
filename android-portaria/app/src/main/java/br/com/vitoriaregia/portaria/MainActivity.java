package br.com.vitoriaregia.portaria;
...
public class MainActivity extends Activity {
    ...
    private static final String BASE_URL = "https://vitoriaregia1.onrender.com/#portaria";
    ...
    private void buildLayout() {
        ...
        offline.setText("Vitória Régia Portaria");
    ...
    private void setupWebView() {
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            public boolean onShowFileChooser(WebView view, ValueCallback<Uri[]> filePathCallback, FileChooserParams fileChooserParams) {
                ...
                try {
                    startActivityForResult(Intent.createChooser(intent, "Selecionar foto ou etiqueta"), REQ_FILE_CHOOSER);
                    return true;
