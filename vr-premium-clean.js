  ...
  function improveHelpSection() {
    ...
    section.innerHTML = `
      ...
      <div class="vr-help-grid">
        <article class="vr-help-card"><span>📚</span><h3>Manual completo</h3><p>Guia detalhado com todas as abas, cadastros, financeiro, administração e emergência.</p><a class="btn btn--primary" href="docs/Manual_Completo_do_Sistema_v4.3.0.pdf" target="_blank">Abrir manual completo</a></article>
        <article class="vr-help-card"><span>👨‍👩‍👧</span><h3>Moradores</h3><p>Aprenda a ver comunicados, reservas, encomendas, visitantes, financeiro e emergência.</p><a class="btn btn--primary" href="docs/Manual_dos_Moradores_v4.3.0.pdf" target="_blank">Abrir manual</a></article>
        <article class="vr-help-card"><span>🛡️</span><h3>Portaria</h3><p>Passo a passo para registrar visitantes, encomendas, fotos e avisos.</p><a class="btn btn--primary" href="docs/Manual_da_Portaria_v4.3.0.pdf" target="_blank">Abrir manual</a></article>
        <article class="vr-help-card"><span>👤</span><h3>Síndico/Administração</h3><p>Cadastros, permissões, financeiro, notificações e configurações.</p><a class="btn btn--primary" href="docs/Manual_do_Sindico_v4.3.0.pdf" target="_blank">Abrir manual</a></article>
        <article class="vr-help-card"><span>📘</span><h3>Funcionalidades</h3><p>Funcionalidades, diferenciais e argumentos para apresentar o sistema aos moradores.</p><a class="btn btn--outline" href="docs/Funcionalidades_e_Diferenciais_do_Sistema_v4.3.0.pdf" target="_blank">Ver funcionalidades</a></article>
      </div>
    `;
  }
