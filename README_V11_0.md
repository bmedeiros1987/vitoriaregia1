...
- Se escolher Vizinho, pede unidade. Se escolher Corredor, pede andar.
- Encomendas: somente morador escolhe receber pelo elevador ou retirar na portaria.
- Baixa de encomenda exige confirmação da portaria e do morador.
- E-mails mantidos no padrão premium do sistema.

Após subir, faça Clear build cache & deploy no Render.
