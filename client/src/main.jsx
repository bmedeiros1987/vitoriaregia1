...
function initialForms(){ return {
  ...
  message:{ subject:'', body:'', unit:'' }, emergency:{ type:'elevador', unit:'', location_type:'login', occurrence_location:'login', neighbor_unit:'', floor:'', message:'' }, settings:{ TELEGRAM_TEST_CHAT_ID:'', ELEVATOR_MAINTENANCE_WHATSAPP:'', EMERGENCY_ALLOW_GENERAL_ALERT:'true' }, systemUpdate:{ validation_code:'', mode:'github' }, document:{ title:'', description:'', audience:'publico', is_public:true }, occurrence:{ title:'', description:'', category:'queixa', priority:'normal', unit:'' }, support:{ subject:'', body:'', priority:'normal' }, financeImport:{ text:'', unit:'', previewRows:[] }
};}
    ...
    <section className="loginCard premiumLoginCard accessCard">
      ...
      {mode==='register' && <form className="registerForm" onSubmit={submitRegister}>
        ...
        <div className="formGrid registerGrid">
          ...
          {channels.telegram && <label>Telegram<input placeholder="ID do Telegram ou @usuário" value={forms.register.telegram_chat_id} onChange={e=>setForm('register',{telegram_chat_id:e.target.value})}/></label>}
        </div>
