...
function UpdatesPage({ data, notify, loadAll, action }) {
  ...
  return <Panel title="Central de atualizações" subtitle="Atualize o sistema pelo próprio painel enviando o ZIP oficial com código e token exclusivos." icon={<UploadCloud />}>
    ...
    <section className="wide"><h3><Download />Primeira ativação</h3><p>A versão v9.1 ainda não tinha atualização automática completa. Suba esta v9.4 uma vez pelo Mac/GitHub. Depois disso, as próximas atualizações poderão ser enviadas por aqui como ZIP validado.</p></section>
  </Panel>;
}
